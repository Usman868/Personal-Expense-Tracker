...
Track income and expenses, calculate net balance, and persist data using **localStorage**. Dark theme with black & gold styling.
...
- Interactive transaction badges for income (gold) and expenses (red)
